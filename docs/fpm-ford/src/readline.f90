! the test program
   program demo_system_readline
      ...
      write(*,*)'  keys and the delete key and just typing characters let you '
      write(*,*)'  do simple editing. Far more input control is available.'
      write(*,*)'  See the man(1) page for readline(3c) for more information.'
      write(*,*)' ____________________________________________________________'
      write(*,*)' Enter commands and then edit them. "q" quits; "h" display history:'
